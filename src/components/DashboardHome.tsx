            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium">Bitcoin allocation increased</p>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium">STRF ETF purchase completed</p>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium">Portfolio rebalancing initiated</p>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-2">
              <button className="w-full text-left px-4 py-2 text-sm bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors">
                View Portfolio Performance
              </button>
              <button className="w-full text-left px-4 py-2 text-sm bg-green-50 hover:bg-green-100 rounded-lg transition-colors">
                Upload Documents
              </button>
              <button className="w-full text-left px-4 py-2 text-sm bg-purple-50 hover:bg-purple-100 rounded-lg transition-colors">
                Contact Support
              </button>
            </div>
          </CardContent>
